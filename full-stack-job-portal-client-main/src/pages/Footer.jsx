        ...
        <div className="container max-w-6xl mx-auto">
          <div className="flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="/src/assets/media/logooo.png"
                    alt="logo"
            ...
            <LinkGroup header="Quick Links">
              ...
              <NavLink link="/all-jobs" label="Explore Jobs" />
              
            </LinkGroup>
            <LinkGroup header="Account">
            <NavLink link="./Login" label="Log In" />
              <NavLink link="./Register" label="Applicant Register" />
              <NavLink link="/recruiter-register" label="Recruiter Register" />
            </LinkGroup>
