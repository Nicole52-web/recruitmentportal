...
import QuizSVG from "../assets/media/Quiz.svg";
...
const Quiz = () => {
    ...
    const handleAnswerClick = (selectedOption) => {
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        setIsQuizCompleted(true);
         // Call handleQuizComplete when quiz is completed
      }
    };
    ...
    const handleQuizComplete = async () => {
      ...
      try {
        await axios.post('http://localhost:3000/api/v1/quiz/results', {
          applicantId: applicantId, // Include the applicantId in the data sent to the backend
          score,
        }, {
          withCredentials: true,
        });
        showToast("Quiz results saved successfully!", true);
      } catch (error) {
        showToast("Failed to save quiz results", false);
      }
    };
    const getTraits = () => {
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection="column">
        {!isQuizStarted ? (
          ...
          <VStack spacing="4" direction="column" align="center" mt="118" mb="8">
            ...
            <Button onClick={handleQuizComplete} className="bg-blue">Submit Result</Button>
