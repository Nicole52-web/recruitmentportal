                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    {...register("position", {
                                        ...
                                        pattern: {
                                            value: /^[A-Za-z\s]+$/,
                                            message: "Invalid characters (only letters allowed)",
                                        },
                                    })}
                                />
                                {errors?.position && (
                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    {...register("vacancy", {
                                        ...
                                        pattern: {
                                            value: /^[0-9]+$/,
                                            message: "Invalid characters (only numbers allowed)",
                                        },
                                    })}
                                />
                                {errors?.vacancy && (
                        ...
                        <div className="flex flex-col  min-[600px]:flex-row  justify-between items-center gap-4 mt-5">
                            <div className="row gap-y-2">
                                ...
                                <TagsInput
                                    ...
                                    onChange={setSkills}
                                    name="skills"
                                    placeHolder="HTML, CSS...Press Enter after Typing"
                                    separators={["Enter", ","]}
                                    onRemoved={["Backspace"]}
                                    classNames={{
                                        tag: "tag-cls",
                            ...
                            <div className="row gap-y-2">
                                <label htmlFor="position">Job Benefits</label>
                                <TagsInput
                                    value={facilities}
                                    onChange={setFacilities}
                                    name="facilities"
                                    placeHolder="Type here...Press Enter after Typing"
                                    separators={["Enter", ","]}
                                    onRemoved={["Backspace"]}
                                    classNames={{
                                        tag: "tag-cls",
